...
//武器データ
//Cs[0Dmg,1HsBonus,2Rate,3CritPer,4CritHighestDmg,5ChangeDmg10m,6MaxChangeDmg,7Capacity,8Reload,9ShotStyle,10Spread,11ADS]
//Csp[0MonaDmg,1EmpHs,2MonaRate,3WlCapacity,4EmpCapacity,5WlReload,6MonaSpread]
const SerenityCs = [13,4,15,0,0,-0.89,-6,32,50,0,0.6,0.15];
const SerenityCsp = [2,3,2,20,10,-30,-0.3];
const DominanceCs = [9,1,20,0,0,-0.98,-3,25,60,0,0.8,0.1];
const DominanceCsp = [2,3,0,20,10,-30,-0.3];
const WarmongerCs = [8,7,10,0.25,6,0,0,28,50,0,0.25,0];
const WarmongerCsp = [2,6,2,20,10,-30,0];
const WoundCs = [11,4,8,0.3,8,0,0,20,50,0,0.55,0.2];
const WoundCsp = [3,4,2,20,10,-30,-0.3];
const AvgCs = [16,4,12,0.3,3,-0.95,-6,25,50,0,0.6,0.1];
const AvgCsp = [2,3,2,20,10,-30,-0.3];
